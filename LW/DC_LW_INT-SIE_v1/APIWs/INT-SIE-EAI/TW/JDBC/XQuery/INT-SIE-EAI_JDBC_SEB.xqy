...
declare function local:INT-SIE-EAI_JDBC_SEB($LegacyResponse as element(), $LegacyResult as element()?) as element() (:: schema-element(ns1:SourceError) ::) {
    ...
    let $ErrorSourceDetails               := "INT-SIE-EAI_JDBC_TW"
...
local:INT-SIE-EAI_JDBC_SEB($LegacyResponse, $LegacyResult)
