...
declare function local:INT-SIE-MAR_HTTPSOAP11_SEB($LegacyResponse as element(), $LegacyResult as element()?) as element() (:: schema-element(ns1:SourceError) ::) {
    ...
    let $ErrorSourceDetails               := "INT-SIE-MAR_HTTPSOAP11_TW"
...
local:INT-SIE-MAR_HTTPSOAP11_SEB($LegacyResponse, $LegacyResult)
