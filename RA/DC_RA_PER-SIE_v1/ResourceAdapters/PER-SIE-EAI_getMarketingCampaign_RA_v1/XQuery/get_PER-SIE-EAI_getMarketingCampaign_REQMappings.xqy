...
declare namespace ns1="http://www.entel.cl/CSM/RA/PER-SIE-EAI/getMarketingCampaign/v1";
...
declare variable $RaREQ as element() (:: schema-element(ns1:PER-SIE-EAI_getMarketingCampaign_REQ) ::) external;
declare variable $GetMappingRSP as element() external;

declare function local:get_PER-SIE-EAI_getMarketingCampaign_REQMappings($RaREQ as element() (:: schema-element(ns1:PER-SIE-EAI_getMarketingCampaign_REQ) ::), 
                                                                 $GetMappingRSP as element()) 
                                                                 as element() (:: schema-element(ns1:PER-SIE-EAI_getMarketingCampaign_REQ) ::) {
    <ns1:PER-SIE-EAI_getMarketingCampaign_REQ>
    (: 
...
local:get_PER-SIE-EAI_getMarketingCampaign_REQMappings($RaREQ, $GetMappingRSP)