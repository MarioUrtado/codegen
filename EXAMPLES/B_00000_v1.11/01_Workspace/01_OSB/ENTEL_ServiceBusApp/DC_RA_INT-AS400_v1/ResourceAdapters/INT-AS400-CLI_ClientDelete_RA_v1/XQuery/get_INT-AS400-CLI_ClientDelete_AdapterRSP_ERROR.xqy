...
declare function local:get_INT-AS400-CLI_ClientDelete_AdapterRSP_ERROR($Result as element() (:: schema-element(ns3:Result) ::)) as element() (:: schema-element(ns2:INT-AS400-CLI_ClientDelete_RSP) ::) {
...
local:get_INT-AS400-CLI_ClientDelete_AdapterRSP_ERROR($Result)