...
declare function local:CHL-SALESFORCE-CRM_HTTPSOAP12_SEB($LegacyResponse as element(), $LegacyResult as element()?) as element() (:: schema-element(ns1:SourceError) ::) {
    ...
    let $ErrorSourceDetails               := "CHL-SALESFORCE-CRM_HTTPSOAP12_TW"
...
local:CHL-SALESFORCE-CRM_HTTPSOAP12_SEB($LegacyResponse, $LegacyResult)
