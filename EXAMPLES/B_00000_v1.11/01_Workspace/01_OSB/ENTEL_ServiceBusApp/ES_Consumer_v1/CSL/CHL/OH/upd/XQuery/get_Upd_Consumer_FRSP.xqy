...
declare function local:get_Get_Consumer_FRSP($ResponseHeader as element() (:: schema-element(ns1:ResponseHeader) ::)) as element() (:: schema-element(ns2:Get_Consumer_FRSP) ::) {
...
local:get_Get_Consumer_FRSP($ResponseHeader)
