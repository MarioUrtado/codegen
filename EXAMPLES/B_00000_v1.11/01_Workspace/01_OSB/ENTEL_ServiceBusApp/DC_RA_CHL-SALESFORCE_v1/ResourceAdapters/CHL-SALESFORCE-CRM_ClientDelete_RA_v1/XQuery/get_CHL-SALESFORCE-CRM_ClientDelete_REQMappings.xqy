...
declare function local:get_CHL-SALESFORCE-CRM_ClientDelete_REQMappings($RaREQ as element() (:: schema-element(ns1:CHL-SALESFORCE-CRM_ClientDelete_REQ) ::), 
                                                                 $GetMappingRSP as element()) 
                                                                 as element() (:: schema-element(ns1:CHL-SALESFORCE-CRM_ClientDelete_REQ) ::) {
    <ns1:CHL-SALESFORCE-CRM_ClientDelete_REQ>
        (: 
...
local:get_CHL-SALESFORCE-CRM_ClientDelete_REQMappings($RaREQ, $GetMappingRSP)