...
declare function local:get_CHL-SALESFORCE-CRM_ClientDelete_AdapterRSP_ERROR($Result as element() (:: schema-element(ns3:Result) ::)) as element() (:: schema-element(ns2:CHL-SALESFORCE-CRM_ClientDelete_RSP) ::) {
...
local:get_CHL-SALESFORCE-CRM_ClientDelete_AdapterRSP_ERROR($Result)
