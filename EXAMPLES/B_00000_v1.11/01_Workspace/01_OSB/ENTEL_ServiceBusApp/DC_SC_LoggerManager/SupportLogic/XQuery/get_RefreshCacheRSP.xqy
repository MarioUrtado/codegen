...
declare namespace ns2="http://www.entel.cl/SC/LoggerManager/refreshCache_LoggerManager/v1";
...
declare function local:get_RefreshCacheRSP($Result as element() (:: schema-element(ns1:Result) ::)) as element() (:: schema-element(ns2:RefreshCache_LoggerManagerRSP) ::) {
    <ns2:RefreshCache_LoggerManagerRSP>
