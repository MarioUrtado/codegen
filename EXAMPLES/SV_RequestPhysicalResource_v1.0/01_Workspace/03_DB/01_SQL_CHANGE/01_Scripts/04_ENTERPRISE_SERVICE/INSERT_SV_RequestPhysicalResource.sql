...
DECLARE
	...
	-- ESB_CAPABILITY_CHECK ----------------------------------------------------------------------------------------------------------------------------
		...
		IF ELEMENT_CONT=0 THEN
			...
			VALUES (ESB_CAPABILITY_CHECK_SEQ.NEXTVAL,( SELECT ID FROM ESB_CAPABILITY WHERE CODE = V_CAP_OP_CODE),'1','1');
		ELSE
...
-- ======================================================================================================================================================
	...
	V_SERV_CODE :='PIM_0009';
	V_SERV_NAME :='RequestPhysicalResource';
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
-------------------------   INICIO BLOQUE   --------------------------------------------------------------------------------------------------------------
	V_CAP_OP_CODE:='OPER_00197';
	V_CAP_OP_NAME:='Create';
