...
declare function local:refreshCacheREQ($category as xs:string) as element() (:: schema-element(ns1:LazyRefreshREQ) ::) {
    <ns1:LazyRefreshREQ>
        <ns1:Key source="MessageManager" category="{fn:data($category)}">
        </ns1:Key>
    </ns1:LazyRefreshREQ>
};
