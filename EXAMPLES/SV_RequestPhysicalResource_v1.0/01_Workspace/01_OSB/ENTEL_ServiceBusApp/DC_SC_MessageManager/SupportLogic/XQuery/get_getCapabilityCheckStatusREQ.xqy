...
declare namespace ns1="http://xmlns.oracle.com/pcbpel/adapter/db/sp/getCapabilityCheckStatus";
(:: import schema at "../JCA/getCapabilityCheckStatus/getCapabilityCheckStatus_sp.xsd" ::)
...
declare function local:getCapacityCheckStatusREQ($service_code as xs:string, 
...
local:getCapacityCheckStatusREQ($service_code, $service_name, $service_operation)
