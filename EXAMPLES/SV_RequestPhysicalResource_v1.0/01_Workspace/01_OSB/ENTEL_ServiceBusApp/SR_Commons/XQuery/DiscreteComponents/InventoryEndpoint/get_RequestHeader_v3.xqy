...
local:get_RequestHeader($processCode, $processArea, $origenEventID, $sysCode, $operationCode, $enterpriseCode, $countryCode, $clientReqTimestamp,$ServiceCode,$ServiceName,$ServiceOperation)