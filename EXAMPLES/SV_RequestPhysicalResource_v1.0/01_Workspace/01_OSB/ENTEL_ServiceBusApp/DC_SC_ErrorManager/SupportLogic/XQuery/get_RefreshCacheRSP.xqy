...
declare namespace ns2="http://www.entel.cl/SC/ErrorManager/refreshCache_ErrorDictionary/v1";
(:: import schema at "../../SupportAPI/XSD/CSM/refreshCache_ErrorDictionary_v1_CSM.xsd" ::)
...
declare function local:get_RefreshCacheRSP($Result as element() (:: schema-element(ns4:Result) ::)) as element() (:: schema-element(ns2:RefreshCache_ErrorDictionaryRSP) ::) {
    <ns2:RefreshCacheRSP>
        {$Result}
    </ns2:RefreshCacheRSP>
};
